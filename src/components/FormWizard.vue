<template>
  <div class="vue-form-wizard" :class="[stepSize, {vertical: isVertical}]" @keyup.right="focusNextTab"
    ...
    <div class="wizard-header" v-if="showHeader">
      <slot name="title">
    ...
    <div class="wizard-navigation">
      <div class="wizard-progress-with-circle" v-if="!isVertical && showTabs == true">
        <div class="wizard-progress-bar"
             :style="progressBarStyle"></div>
      </div>
      <ul class="wizard-nav wizard-nav-pills" role="tablist" :class="stepsClasses" v-if="showTabs">
